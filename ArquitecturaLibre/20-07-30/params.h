...
const double mutationVariance = 8 /* Lo aumenté xq tengo muchos más parametros, y si lo reparto me queda casi nada en cada uno0.5*/;
const double crossoverProb = 0.62;

const int PARENTS_TOURNAMENT_SIZE = 20;

// Architecture evolution
const double randomMutProb=0.08;
